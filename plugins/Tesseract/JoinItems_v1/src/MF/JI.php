...
public function JoinItems(PlayerJoinEvent $event){
   ...
   $item1->setCustomName("§d Item này sẽ giúp bạn tìm hiểu cách chơi trong PlanetMine\n§b Ấn giữ để sử dụng");
   $item1->addEnchantment(Enchantment::getEnchantment()->setLevel(0));
   $sender->getInventory()->addItem($item1);

   $item3 = Item::get(403, 0, 1);
   $item3->setCustomName("§a Quy Định - Luật Chơi - PlanetMine\n§b Ấn giữ để sử dụng");
   ...
   $armor3->setCustomName("§a Thông Tin Giới Thiệu Về PlanetMine\n§b Ấn giữ để sử dụng");
